...
$sm_lang = array(
	...
	'users' => array(
		...
		'pushbullet_description' => 'Pushbullet is a service that makes it easy to get real-time notifications. See <a href="https://pushbullet.com/">their website</a> for more info.',
	...
	'config' => array(
		...
		'pushbullet_description' => 'Pushbullet is a service that makes it easy to get real-time notifications. See <a href="https://pushbullet.cpm/">their website</a> for more info.',
		'pushbullet_clone_app' => 'Click here to create your Pushbullet app',
		'pushbullet_api_token' => 'Pushbullet App API Token',
		'pushbullet_api_token_description' => 'Before you can use Pushbullet, you need to get an api token at <a href="https://pushbullet.cpm/">their website</a> and enter the App API Token here.',
		...
		'pushbullet_error_noapp' => 'Unable to send test notification: no Pushbullet App API token found in the global configuration.',
		'pushbullet_error_nokey' => 'Unable to send test notification: no Pushbullet key found in your profile.',
	...
	'notifications' => array(
		...
		'off_pushbullet_message' => "Failed to connect to the following server:<br/><br/>Server: %LABEL%<br/>IP: %IP%<br/>Port: %PORT%<br/>Error: %ERROR%<br/>Date: %DATE%",
		...
		'on_pushbullet_message' => 'Server \'%LABEL%\' is running again:<br/><br/>Server: %LABEL%<br/>IP: %IP%<br/>Port: %PORT%<br/>Date: %DATE%',
	),
	'login' => array(
