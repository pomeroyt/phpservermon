...
class UserController extends AbstractController {
	...
	protected function executeIndex() {
		...
		$users = $this->db->select(
			PSM_DB_PREFIX.'users',
			null,
			array('user_id', 'user_name', 'level', 'name', 'mobile', 'pushover_key', 'pushover_device', 'pushover_key', 'pushover_device', 'pushbullet_key', 'pushbullet_device', 'pushbullet_key', 'pushbullet_device', 'email'),
			null,
			array('name')
		);
	...
	protected function executeEdit() {
		...
		$fields_prefill = array('name', 'user_name', 'mobile', 'pushover_key', 'pushover_device', 'pushover_key', 'pushover_device', 'pushbullet_key', 'pushbullet_device', 'pushbullet_key', 'pushbullet_device', 'email');
	...
	protected function executeSave() {
		...
		$fields = array('name', 'user_name', 'password', 'password_repeat', 'level', 'mobile', 'pushover_key', 'pushover_device', 'pushover_key', 'pushover_device', 'pushbullet_key', 'pushbullet_device', 'pushbullet_key', 'pushbullet_device', 'email');
		$clean = array();
